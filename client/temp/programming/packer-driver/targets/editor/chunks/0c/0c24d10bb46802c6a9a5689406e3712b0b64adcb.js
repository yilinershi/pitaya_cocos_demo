System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, proto, Http, Pitaya2, Session, LoginController, _crd, starx;
  ...
  function _reportPossibleCrUseOfPitaya(extras) {
    _reporterNs.report("Pitaya2", "../../net/pitaya/Pitaya2", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("LoginController", LoginController = class LoginController {
        ...
        static async OnConnectorAuth() {
          await (_crd && Pitaya2 === void 0 ? (_reportPossibleCrUseOfPitaya({
            error: Error()
          }), Pitaya2) : Pitaya2).Init((_crd && Session === void 0 ? (_reportPossibleCrUseOfSession({
            error: Error()
          ...
          let respByte = await (_crd && Pitaya2 === void 0 ? (_reportPossibleCrUseOfPitaya({
            error: Error()
          }), Pitaya2) : Pitaya2).Call("Connector.Handler.CallAuth", reqByte);
...
//# sourceMappingURL=0c24d10bb46802c6a9a5689406e3712b0b64adcb.js.map