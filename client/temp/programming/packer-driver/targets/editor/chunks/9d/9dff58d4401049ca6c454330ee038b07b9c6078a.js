    ...
    execute: function () {
      ...
      _export("PitayaWs", PitayaWs = class PitayaWs {
        ...
        static CallAuth() {
          ...
          console.log(" pitaya CallAuth  reqByte ", reqByte);
        ...
        static StartXCallAuth() {
          starx.init({
            ...
            console.error("REQBET SF ", reqByte);
        ...
        static sendMessage(reqId, route, msg) {
          ...
          console.log("sfjsldjflsj encodeMsg ", encodeMsg);
          var packet = protocol.Package.encode(protocol.Package.TYPE_DATA, encodeMsg);
          console.log("sfjsldjflsj packet ", packet); // this.send(packet);
        }
...
//# sourceMappingURL=9dff58d4401049ca6c454330ee038b07b9c6078a.js.map