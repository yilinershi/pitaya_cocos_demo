    ...
    execute: function () {
      ...
      _export("PitayaWs", PitayaWs = class PitayaWs {
        ...
        static Call(route, data) {
          ...
          this._reqId++;
          let msg = protocol.Message.encode(this._reqId, (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
        ...
        static CallAuth() {
          ...
          let msg = protocol.Message.encode(this._reqId, (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Message.TYPE_REQUEST, 0, "Connector.Handler.CallAuth", reqByte);
          let pkg = protocol.Package.encode((_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Package.TYPE_DATA, msg); // let msg = Pomelo.Message.encode(this._reqId, Pomelo.Message.TYPE_REQUEST, 0, route, data);
          // let pkg = Pomelo.Package.encode(Pomelo.Package.TYPE_DATA, msg)
...
//# sourceMappingURL=cb79bdb179b19a925b23c4d57b87ff2387ff3748.js.map