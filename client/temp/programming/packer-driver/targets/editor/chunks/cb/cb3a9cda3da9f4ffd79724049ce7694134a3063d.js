    ...
    execute: function () {
      ...
      _export("PitayaWs", PitayaWs = class PitayaWs {
        ...
        static Call(route, msg) {
          this._reqId++;
          let message = (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          ...
          this._ws.send((_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            ...
            error: Error()
          }), Pomelo) : Pomelo).Package.TYPE_DATA, message).buffer);
        }
...
//# sourceMappingURL=cb3a9cda3da9f4ffd79724049ce7694134a3063d.js.map