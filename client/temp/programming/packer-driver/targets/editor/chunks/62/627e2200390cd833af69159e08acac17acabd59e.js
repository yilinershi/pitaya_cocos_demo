    ...
    execute: function () {
      ...
      _export("Pitaya", Pitaya = class Pitaya {
        ...
        static async Call(route, data) {
          ...
          return new Promise((resolve, reject) => {
            this.reqId++;
            let type = this.reqId ? protocol.Message.TYPE_REQUEST : protocol.Message.TYPE_NOTIFY;
            let msg = protocol.Message.encode(this.reqId, type, 0, route, data);
...
//# sourceMappingURL=627e2200390cd833af69159e08acac17acabd59e.js.map