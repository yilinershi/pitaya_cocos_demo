    ...
    execute: function () {
      ...
      _export("PitayaWs", PitayaWs = class PitayaWs {
        ...
        static Call(route, data) {
          ...
          this.reqId++;
          let msg = protocol.Message.encode(this.reqId, (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Message.TYPE_REQUEST, 0, route, data);
          let pkg = protocol.Package.encode((_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Package.TYPE_DATA, msg); // let msg = Pomelo.Message.encode(this._reqId, Pomelo.Message.TYPE_REQUEST, 0, route, data);
        ...
        static CallAuth() {
          ...
          this.request("Connector.Handler.CallAuth", reqByte, () => {}); // this.testStartX()
        }
        ...
        static sendMessage(reqId, route, msg) {
          ...
          var encodeMsg = protocol.Message.encode(reqId, type, 0, route, msg);
...
//# sourceMappingURL=8e1d82a76ed1f98426de50e67480c6c77d221af8.js.map