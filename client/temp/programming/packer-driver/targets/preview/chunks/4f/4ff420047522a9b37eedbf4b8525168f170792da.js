    ...
    execute: function () {
      ...
      _export("PitayaWs", PitayaWs = class PitayaWs {
        static Init(url) {
          ...
          return _asyncToGenerator(function* () {
            return new Promise((reslove, reject) => {
              _this._ws = new WebSocket('ws://' + url);
              _this._reqId = 0;
        ...
        static Call(route, msg) {
          ...
          this._reqId++;
          var message = (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Message.encode(this._reqId, (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Message.TYPE_REQUEST, 0, route, msg);

          this._ws.send((_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Package.encode((_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
            error: Error()
          }), Pomelo) : Pomelo).Package.TYPE_DATA, message));
        }
...
//# sourceMappingURL=4ff420047522a9b37eedbf4b8525168f170792da.js.map