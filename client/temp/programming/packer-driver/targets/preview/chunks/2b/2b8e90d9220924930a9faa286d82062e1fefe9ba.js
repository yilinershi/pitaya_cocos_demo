System.register(["__unresolved_0", "cc", "buffer"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, Buffer, _crd, Pomelo;

  function _reportPossibleCrUseOfBuffer(extras) {
    _reporterNs.report("Buffer", "buffer", _context.meta, extras);
  }
      ...
      (function (_Pomelo) {
        ...
        class Protocol {
          ...
          static strencode(str) {
            var byteArray = (_crd && Buffer === void 0 ? (_reportPossibleCrUseOfBuffer({
              error: Error()
            }), Buffer) : Buffer).alloc(str.length * 3);
            var offset = 0;
            ...
            var _buffer = (_crd && Buffer === void 0 ? (_reportPossibleCrUseOfBuffer({
              error: Error()
          ...
          static encode(id, type, compressRoute, route, msg, compressGzip) {
            ...
            if (msgHasRoute(type)) {
              if (compressRoute) {
                ...
                if (route) {
                  var routebuf = Protocol.strencode(route);
          ...
          static decode(buffer) {
            ...
            if (msgHasRoute(type)) {
              if (compressRoute) {
                ...
                if (routeLen) {
                  var routeByte = new Uint8Array(routeLen);
...
//# sourceMappingURL=2b8e90d9220924930a9faa286d82062e1fefe9ba.js.map