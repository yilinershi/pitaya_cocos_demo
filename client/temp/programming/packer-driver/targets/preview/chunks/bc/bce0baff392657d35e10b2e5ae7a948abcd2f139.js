      ...
      _export("Pitaya", Pitaya = class Pitaya {
        ...
        static sendHandShake() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var msg = protocol.Protocol.strencode(JSON.stringify(handshakeBuffer));
        ...
        static dispatch(msg) {
          switch (msg.type) {
            case protocol.Package.TYPE_HANDSHAKE:
              {
                var data = JSON.parse(protocol.Protocol.strdecode(msg.body));
...
//# sourceMappingURL=bce0baff392657d35e10b2e5ae7a948abcd2f139.js.map