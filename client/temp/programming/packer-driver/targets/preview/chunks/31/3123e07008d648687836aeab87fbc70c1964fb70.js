  ...
  return {
    ...
    execute: function () {
      ...
      (function (_Pomelo) {
        ...
        var MSG_ROUTE_CODE_BYTES = 2; //const MSG_ID_MAX_BYTES = 5;
        ...
        class Package {
          ...
          static encodeBatch(bodys) {
            ...
            for (var _i = 0, _l = bodys.length; _i < _l; ++_i) {
              var body = bodys[_i],
...
//# sourceMappingURL=3123e07008d648687836aeab87fbc70c1964fb70.js.map