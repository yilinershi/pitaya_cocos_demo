      ...
      _export("LoginController", LoginController = class LoginController {
        ...
        static OnConnectorAuth() {
          return _asyncToGenerator(function* () {
            ...
            var reqByte = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
            }), proto) : proto).lobby.ReqAuth.encode(req).finish(); // PitayaWs.Call("Connector.Handler.CallAuth", reqByte)
...
//# sourceMappingURL=c02b1683d4960132087ac3340279976822ec1471.js.map