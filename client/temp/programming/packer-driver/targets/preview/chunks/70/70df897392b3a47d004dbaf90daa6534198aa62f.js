System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, proto, Http, PitayaWs, Session, LoginController, _crd;
      ...
      _export("LoginController", LoginController = class LoginController {
        ...
        static OnConnectorAuth() {
          return _asyncToGenerator(function* () {
            ...
            //     return
            // }
            yield (_crd && PitayaWs === void 0 ? (_reportPossibleCrUseOfPitayaWs({
              error: Error()
            ...
            var reqByte = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
            }), proto) : proto).lobby.ReqAuth.encode(req).finish();
            (_crd && PitayaWs === void 0 ? (_reportPossibleCrUseOfPitayaWs({
              error: Error()
            }), PitayaWs) : PitayaWs).Call("Connector.Handler.CallAuth", reqByte);
          })();
        }
...
//# sourceMappingURL=70df897392b3a47d004dbaf90daa6534198aa62f.js.map