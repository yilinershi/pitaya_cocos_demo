        ...
        $root.lobby = function () {
          ...
          lobby.RespLobbyInfo = function () {
            ...
            RespLobbyInfo.encode = function encode(message, writer) {
              if (!writer) writer = $Writer.create();
              if (message.Infos != null && message.Infos.length) for (var i = 0; i < message.Infos.length; ++i) {
                $root.lobby.RespLobbyInfo.LobbyInfo.encode(message.Infos[i], writer.uint32(
                /* id 1, wireType 2 =*/
                10).fork()).ldelim();
              }
              return writer;
...
//# sourceMappingURL=552a182a132f71bb761e344d8be430e1e70b79b9.js.map