System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfSession(extras) {
    _reporterNs.report("Session", "../../logic/login/LoginModel.js", _context.meta, extras);
  }
                  ...
                  switch (msg.type) {
                    case (_crd && Pomelo === void 0 ? (_reportPossibleCrUseOfPomelo({
                    ...
                    }), Pomelo) : Pomelo).Package.TYPE_HANDSHAKE:
                      {
                        ...
                        if (data.code === _this.RES_OLD_CLIENT) {
                          return;
                        }

                        if (data.code !== _this.RES_OK) {
                          return;
                        } //一定要握手回应，不然服务器会断开
...
//# sourceMappingURL=b8905cd4e989444a50606f5eb7a53295946f3cdd.js.map