        ...
        static OnConnectorAuth() {
          return _asyncToGenerator(function* () {
            (_crd && Pitaya === void 0 ? (_reportPossibleCrUseOfPitaya({
              error: Error()
            }), Pitaya) : Pitaya).OnConnectSuccess = () => {
              var reqByte = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
                error: Error()
              ...
              (_crd && Pitaya === void 0 ? (_reportPossibleCrUseOfPitaya({
                error: Error()
              }), Pitaya) : Pitaya).request("Connector.Handler.CallAuth", reqByte, () => {});
            };
...
//# sourceMappingURL=d62500fc9a0456917bca0d0c93b92823b31b81e2.js.map