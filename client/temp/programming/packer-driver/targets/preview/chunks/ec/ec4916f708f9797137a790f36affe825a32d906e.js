      ...
      _export("LoginController", LoginController = class LoginController {
        ...
        static TestChat() {
          (_crd && Pitaya === void 0 ? (_reportPossibleCrUseOfPitaya({
            ...
            var pushData = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
            }), proto) : proto).chat.SyncChatInfo.decode(data);
            console.log("Chat.Handler.PushChat, pushData=", pushData);
          });
          var notifyData = (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
...
//# sourceMappingURL=ec4916f708f9797137a790f36affe825a32d906e.js.map